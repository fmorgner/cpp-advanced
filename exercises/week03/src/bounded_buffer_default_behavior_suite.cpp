...
void test_default_constructed_const_int_buffer_of_size_one_is_empty() {
	BoundedBuffer<int, 0> const buffer{};
	ASSERTM("New buffer should be empty", buffer.empty());
}

void test_default_constructed_const_int_buffer_of_size_thousand_is_not_full() {
	BoundedBuffer<int, 1000> const buffer{};
	ASSERTM("New buffer should not be full", !buffer.full());
}

void test_default_constructed_const_int_buffer_of_size_one_is_full() {
	BoundedBuffer<int, 0> const buffer{};
	ASSERTM("New buffer of size 0 should be full", buffer.full());
}

void test_default_constructed_const_int_buffer_of_size_thousand_has_size_zero() {
	BoundedBuffer<int, 1000> const buffer{};
	ASSERTM("New buffer should be empty", buffer.empty());
}

void test_default_constructed_const_int_buffer_of_size_size_has_size_zero() {
	BoundedBuffer<int, 0> const buffer{};
	ASSERTM("New buffer should be empty", buffer.empty());
}
...
cute::suite make_suite_bounded_buffer_default_behavior_suite(){
	cute::suite s{};
	s.push_back(CUTE(test_default_constructed_const_int_buffer_of_size_thousand_is_empty));
	s.push_back(CUTE(test_default_constructed_const_int_buffer_of_size_one_is_empty));
	s.push_back(CUTE(test_default_constructed_const_int_buffer_of_size_thousand_is_not_full));
	s.push_back(CUTE(test_default_constructed_const_int_buffer_of_size_one_is_full));
	s.push_back(CUTE(test_default_constructed_const_int_buffer_of_size_thousand_has_size_zero));
	s.push_back(CUTE(test_default_constructed_const_int_buffer_of_size_size_has_size_zero));
